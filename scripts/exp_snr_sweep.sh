#!/usr/bin/env bash
# =============================================================================
# scripts/exp_snr_sweep.sh
# =============================================================================
#
# min-SINR & sum-SCNR vs operating SNR P_max/σ² [dB].
#
# Wrapper around scripts/exp_snr_sweep.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_snr_sweep.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_snr_sweep.sh
# =============================================================================
...
EXP_CONFIG="${EXP_CONFIG:-configs/exp_snr_sweep.json}"   # generated by configs/recipes/exp_snr_sweep.sh
...
SWEEP_ARGS=()
[ -n "$SNR_VALUES_DB" ] && SWEEP_ARGS+=(--snr-values-db "$SNR_VALUES_DB")
python3 scripts/exp_snr_sweep.py \
