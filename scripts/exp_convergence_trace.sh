...
#
# Wrapper around scripts/exp_convergence_trace.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_convergence_trace.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_convergence_trace.sh
# =============================================================================
