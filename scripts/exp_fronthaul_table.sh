...
#
# Wrapper around scripts/exp_fronthaul_table.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_fronthaul_table.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_fronthaul_table.sh
# =============================================================================
...
SWEEP_ARGS=()
[ -n "$N_ADMM_DROPS" ] && SWEEP_ARGS+=(--n-admm-drops "$N_ADMM_DROPS")
