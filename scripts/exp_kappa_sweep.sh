#!/usr/bin/env bash
# =============================================================================
# scripts/exp_kappa_sweep.sh
# =============================================================================
#
# min-SINR & sum-SCNR vs clutter penalty κ.
#
# Wrapper around scripts/exp_kappa_sweep.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_kappa_sweep.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_kappa_sweep.sh
# =============================================================================
...
EXP_CONFIG="${EXP_CONFIG:-configs/exp_kappa_sweep.json}"   # generated by configs/recipes/exp_kappa_sweep.sh
...
SWEEP_ARGS=()
[ -n "$KAPPA_VALUES" ] && SWEEP_ARGS+=(--kappa-values "$KAPPA_VALUES")
python3 scripts/exp_kappa_sweep.py \
