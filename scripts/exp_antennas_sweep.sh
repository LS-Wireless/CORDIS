...
#
# Wrapper around scripts/exp_antennas_sweep.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_antennas_sweep.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_antennas_sweep.sh
# =============================================================================
...
SWEEP_ARGS=()
[ -n "$N_ANT_VALUES" ] && SWEEP_ARGS+=(--n-ant-values "$N_ANT_VALUES")
