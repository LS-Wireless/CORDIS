#!/usr/bin/env bash
# =============================================================================
# scripts/exp_scnr_cdf.sh
# =============================================================================
#
# Empirical CDF of sum-SCNR (sensing performance) across trials.
#
# Wrapper around scripts/exp_scnr_cdf.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_scnr_cdf.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_scnr_cdf.sh
# =============================================================================
...
EXP_CONFIG="${EXP_CONFIG:-configs/exp_scnr_cdf.json}"   # generated by configs/recipes/exp_scnr_cdf.sh
...
python3 scripts/exp_scnr_cdf.py \
