...
#
# Wrapper around scripts/exp_scnr_cdf.py that sets defaults appropriate
...
# OR N_DROPS and N_REAL explicitly.  See `python3 scripts/exp_scnr_cdf.py --help`.
# Per-experiment fallback when nothing else is set: 50 drops × 4 real.
N_DROPS="${N_DROPS:-}"
N_REAL="${N_REAL:-}"
N_TRIALS="${N_TRIALS:-}"
