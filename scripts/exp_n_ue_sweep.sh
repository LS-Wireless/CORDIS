#!/usr/bin/env bash
# =============================================================================
# scripts/exp_n_ue_sweep.sh
# =============================================================================
#
# min-SINR & sum-SCNR vs number of UEs.
#
# Wrapper around scripts/exp_n_ue_sweep.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_n_ue_sweep.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_n_ue_sweep.sh
# =============================================================================
...
EXP_CONFIG="${EXP_CONFIG:-configs/exp_n_ue_sweep.json}"   # generated by configs/recipes/exp_n_ue_sweep.sh
...
SWEEP_ARGS=()
[ -n "$N_UE_VALUES" ] && SWEEP_ARGS+=(--n-ue-values "$N_UE_VALUES")
