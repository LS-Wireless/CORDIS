...
#
# Wrapper around scripts/exp_n_ue_sweep.py that sets defaults appropriate
...
# OR N_DROPS and N_REAL explicitly.  See `python3 scripts/exp_n_ue_sweep.py --help`.
