...
SLURM_DEFAULTS_BY_KIND: Dict[str, Dict[str, str]] = {
    # CDFs:   N_TRIALS ≈ 200, single config       → moderate
    "single": {"time": "02:00:00", "mem": "16G", "cpus": "16"},
    # Sweeps: N_TRIALS ≈ 100 × ~5 points = 500    → heavy
    "sweep":  {"time": "04:00:00", "mem": "16G", "cpus": "16"},
    # Trace:  single trial, ADMM iters traced     → light
    "trace":  {"time": "00:30:00", "mem":  "8G", "cpus":  "8"},
    # Table:  small sweep over n_ap               → light-moderate
    "table":  {"time": "01:00:00", "mem": "16G", "cpus": "16"},
}
...
export CORDIS_PYTHON_MODULE="${CORDIS_PYTHON_MODULE:-python/3.12}"
