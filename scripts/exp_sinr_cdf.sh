...
#
# Wrapper around scripts/exp_sinr_cdf.py.  Every knob below is listed for
...
#
#     N_TRIALS=500 bash scripts/exp_sinr_cdf.sh
#     SEED=123 OUTPUT_ROOT=/scratch/results bash scripts/exp_sinr_cdf.sh
# =============================================================================
