"""
cordis/visualization/topology_viz.py
=====================================
...
All functions accept an optional ``save_path`` argument.  When supplied,
the figure is saved to that path (format inferred from the extension, e.g.
``.png``, ``.pdf``, ``.svg``).
...
-------------
    ...
    from cordis.visualization.topology_viz import plot_topology_2d, plot_topology_summary
    ...
    plot_topology_summary(topo, lsf, save_path="results/topology_trial1.png")
"""
