...
def build_array_cdf_notebook() -> dict:
    cells = [
        ...
        code(
            ...
            ")",
            "ax.set_title(rf'{EXPERIMENT}: full CDF with $\\gamma$={GAMMA_DB:.0f} dB')",
            "ax.set_xlabel(f'min-{METRIC_DISPLAY} [dB]')",
            "plt.show()",
        ),
        code(
            ...
            ")",
            "ax.set_title(rf'{EXPERIMENT}: feasible-only CDF at $\\gamma$={GAMMA_DB:.0f} dB')",
            "ax.set_xlabel(f'min-{METRIC_DISPLAY} [dB]')",
            "plt.show()",
        ),
        md(
...
def build_array_sweep_notebook() -> dict:
    cells = [
        ...
        md("## 9. Save with provenance metadata"),
        code(
            "from cordis.plotting import save_figure",
            "",
            "out = save_figure(",
