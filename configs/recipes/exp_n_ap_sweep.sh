#!/usr/bin/env bash
# =============================================================================
# configs/recipes/exp_n_ap_sweep.sh
# =============================================================================
#
# min-SINR & sum-SCNR vs number of APs.
#
# Usage:
#   bash configs/recipes/exp_n_ap_sweep.sh                 # write configs/exp_n_ap_sweep.json
#   bash configs/recipes/exp_n_ap_sweep.sh --dry-run       # preview the diff
#
