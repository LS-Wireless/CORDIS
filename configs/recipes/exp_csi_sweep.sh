#!/usr/bin/env bash
# =============================================================================
# configs/recipes/exp_csi_sweep.sh
# =============================================================================
#
# min-SINR & sum-SCNR vs uplink pilot power P_p/σ_n² [dB] (CSI estimation error).
#
# Usage:
#   bash configs/recipes/exp_csi_sweep.sh                 # write configs/exp_csi_sweep.json
#   bash configs/recipes/exp_csi_sweep.sh --dry-run       # preview the diff
#
