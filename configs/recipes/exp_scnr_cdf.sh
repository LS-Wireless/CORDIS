#!/usr/bin/env bash
# =============================================================================
# configs/recipes/exp_scnr_cdf.sh
# =============================================================================
#
# Empirical CDF of sum-SCNR (sensing performance) across trials.
#
# Usage:
#   bash configs/recipes/exp_scnr_cdf.sh                 # write configs/exp_scnr_cdf.json
#   bash configs/recipes/exp_scnr_cdf.sh --dry-run       # preview the diff
#
