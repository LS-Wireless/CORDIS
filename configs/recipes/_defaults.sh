...
UE_MIN_SEPARATION_M="${UE_MIN_SEPARATION_M:-0.0}"
UE_TARGET_MIN_SEPARATION_M="${UE_TARGET_MIN_SEPARATION_M:-0.0}"
H_AP_M="${H_AP_M:-10.0}"
H_UE_M="${H_UE_M:-1.5}"
H_TG_M="${H_TG_M:-1.5}"
...
SET_ARGS=(
    ...
    topology.ue_min_separation_m="$UE_MIN_SEPARATION_M"
    topology.ue_target_min_separation_m="$UE_TARGET_MIN_SEPARATION_M"
